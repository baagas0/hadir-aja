			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<div class="d-flex flex-lg-row-fluid">
					<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
						...
						<div class="text-gray-600 fs-base text-center fw-semibold">
							Dengan antarmuka intuitif dan fitur canggih, platform ini membuat manajemen absensi menjadi lebih sederhana dan menyenangkan.
						<div class="text-gray-600 fs-base text-center fw-semibold">
						</div>
						Tinggalkan cara manual, temukan kemudahan dan akurasi dengan Hadir Aja - solusi terbaik untuk manajemen kehadiran modern!
						</div>
					</div>
				</div>
					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="home" method="POST" action="{{ route('login') }}">
									<div class="text-center mb-11">
										<h1 class="text-gray-900 fw-bolder mb-3">Daftar</h1>
										<div class="text-gray-500 fw-semibold fs-6">Isi form 5 menit, dan dapatkan gratis 30 hari</div>
									</div>
									<div class="row g-3 mb-9">
										<div class="col-md-12">
											<a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
											<img alt="Logo" src="{{ asset('assets/media/svg/brand-logos/google-icon.svg') }}" class="h-15px me-3" />Daftarkan Sekolah Anda</a>
										</div>
									</div>
									...
									<div class="fv-row mb-3">
										<input type="password" placeholder="Password" name="password" class="form-control bg-transparent @error('password') is-invalid @enderror"  autocomplete="current-password"/>
										@error('password')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
