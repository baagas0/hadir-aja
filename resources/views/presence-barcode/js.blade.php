@php
    ...
    $route = [
        'detail' => route('presence-barcode.data.detail'),
        'update' => route('presence-barcode.update'),
        'store' => route('presence-barcode.store'),
        'delete' => route('presence-barcode.delete'),
        'bulk-delete' => route('presence-barcode.bulk.delete'),
    ];
@endphp
<script>
    "use strict";
    ...
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#table_{{ $_id }}").DataTable({
                ...
                ajax: {
                    url: "{{ route('presence-barcode.data') }}",
                },
                columns: [
                    { data: 'id' },
                    { data: 'date' },
        ...
        var modalShow = function () {
            ...
            m.addEventListener('show.bs.modal', event => {
                ...
                if (state === 'update') {
                    //  CUSTOM UPDATE
                    console.log('edit')
                    $('#school_position_id').css('visibility','collapse');
                    ...
                    //  CUSTOM CREATE
                    console.log('create')
                    $('#school_position_id').css('visibility','visible');
