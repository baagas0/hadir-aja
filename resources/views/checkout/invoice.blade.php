    ...
    <div class="card-body p-lg-20">
        ...
        <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
            ...
            <div class="d-flex flex-stack pb-10">
                ...
                <!--end::Logo-->
                @if($payment->approval_status == '0')
                <!--begin::Action-->
                <a href="https://tripay.co.id/checkout/{{ $payment->reference }}" class="btn btn-sm btn-success">Pay Now</a>
                <!--end::Action-->
                @endif
            </div>
            <!--end::Top-->
            ...
            <div class="m-0">
                <!--begin::Label-->
                <div class="fw-bold fs-3 text-gray-800 mb-8">Invoice #{{ $payment->merchant_ref }}</div>
                <!--end::Label-->
                <!--begin::Row-->
                ...
                <div class="col-sm-6">
                    ...
                    <!--end::Label-->
                    <!--end::Col-->
                    <div class="fw-bold fs-6 text-gray-800">{{ $payment->created_at->format('d M Y') }}</div>
                    <!--end::Col-->
                </div>
                <!--end::Col-->
                <!--end::Col-->
                <div class="col-sm-6">
                    ...
                    <span class="pe-2">{{ $payment->expired_at->format('d M Y') }}</span>
                    <span class="fs-7 text-danger d-flex align-items-center">
                        {{-- <span class="bullet bullet-dot bg-danger me-2"></span>Due in {{ $payment->expired_at->diff(\Carbon\Carbon::now())->days }} days</span> --}}
                    </div>
                    <!--end::Info-->
                </div>
                <!--end::Col-->
                ...
                <div class="col-sm-6">
                    ...
                    <!--end::Label-->
                    <!--end::Text-->
                    <div class="fw-bold fs-6 text-gray-800">{{ $payment->school->school_name }}.</div>
                    <!--end::Text-->
                    <!--end::Description-->
                    <div class="fw-semibold fs-7 text-gray-600">{{ $payment->school->pic_name }}</div>
                    <div class="fw-semibold fs-7 text-gray-600">{{ $payment->school->school_address }}</div>
                    <!--end::Description-->
                </div>
                <!--end::Col-->
                <!--end::Col-->
                ...
                <div class="table-responsive border-bottom mb-9">
                    ...
                    <tbody>
                        ...
                        <td class="d-flex align-items-center pt-6">
                            <i class="fa fa-genderless text-danger fs-2 me-2"></i>{{ $payment->package->name }}
                        </td>
                        <td class="pt-6">1 Bulan</td>
                        <td class="pt-6">-</td>
                        <td class="pt-6 text-gray-900 fw-bolder">Rp. {{ number_format($payment->amount, '2') }}</td>
                        </tr>

                        @foreach ($payment->package->services as $item)
                        <tr class="fw-bold text-gray-700 fs-5 text-end">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <div class="d-flex flex-stack mb-3">
                        ...
                        <!--end::Accountname-->
                        <!--begin::Label-->
                        <div class="text-end fw-bold fs-6 text-gray-800">Rp. {{ number_format($payment->amount, '2') }}</div>
                        <!--end::Label-->
                    </div>
                    <!--end::Item-->
                    </div>
        ...
        <div class="m-0" style="max-width: 300px">
            ...
            <div class="mb-15">
                ...
                <span class="fs-7 text-danger d-flex align-items-center">
                    {{-- <span class="bullet bullet-dot bg-danger mx-2"></span>Due in {{ $payment->expired_at->diff(\Carbon\Carbon::now())->days }} days</span> --}}
                </div>
            </div>
            <!--end::Item-->
            <!--begin::Title-->
            ...
            <div class="mb-6">
                ...
                <div class="fw-bold fs-6 text-gray-800">{{ $payment->package->name }}
                <a href="#" class="link-primary ps-1">{{ $payment->package->code }}</a>
                </div>
            </div>
            <!--end::Item-->
            <!--begin::Item-->
            <div class="mb-6">
                ...
                {{ $payment->school->school_name }}
                <span class="fs-7 text-success d-flex align-items-center"><span class="bullet bullet-dot bg-success mx-2"></span>{{ $payment->school->pic_name }}</span>
                </div>
            </div>
            <!--end::Item-->
            <!--begin::Item-->
