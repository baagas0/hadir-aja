@php
    ...
    $route = [
        'detail' => route('school-location.data.detail'),
        'update' => route('school-location.update'),
        'store' => route('school-location.store'),
        'delete' => route('school-location.delete'),
    ...
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#table_{{ $_id }}").DataTable({
                ...
                ajax: {
                    url: "{{ route('school-location.data') }}",
                },
                columns: [
                    { data: 'id' },
                    { data: 'title' },
